...
function _createBooksLst() {
    // If gBooks has starter - save it to storage
    if (gBooks.length) return _saveBooksToStorage()

    // Else - create random book lst and save it to storage
